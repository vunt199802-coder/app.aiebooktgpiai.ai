export const generalSettingList = [
  ...
  },
  {
    ...
    desc: "When AI eBook Library Tanjung Piai is running, your computer won't enter sleep mode",
    propName: "isPreventSleep",
  },
  {
    isElectron: true,
    title: "Open book without adding it to library",
    desc: "When opening books in the file manager with AI eBook Library Tanjung Piai, the opened books won't be added to the library",
  ...
  },
  {
    ...
    desc: "Pre-cache books after import to increase opening speed, AI eBook Library Tanjung Piai will generate a precache version of the original book and save it into your library",
...
export const readingSettingList = [
  ...
  },
  {
    ...
    desc: "Turn it on when you want AI eBook Library Tanjung Piai to work with other third-party translation service, right clicking on the selected text will trigger popup again",
