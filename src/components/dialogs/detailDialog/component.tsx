...
class DetailDialog extends React.Component<DetailDialogProps, DetailDialogState> {
  ...
  render() {
    return (
      <div className="download-desk-container" style={{ color: this.state.textColor }}>
        <div
        ...
        >
          <div style={{ position: "relative" }}>
            <div className="detail-cover-container">
              {this.props.currentBook.cover ? (
                <img src={this.props.currentBook.cover} alt="" className="detail-cover" />
              ) : (
                <div className="detail-cover" style={{ width: "125px", height: "170px" }}>
                  <EmptyCover
                    {...{
          ...
          <p className="detail-dialog-book-title">{this.props.currentBook.name}</p>
          ...
          <div className="detail-sub-info">
            <p className="detail-dialog-book-publisher">
              ...
              <p className="detail-sub-content-container">
                <p className="detail-sub-content">{this.props.currentBook.publisher}</p>
              </p>
            </p>
            <p className="detail-dialog-book-divider" style={{ backgroundColor: this.state.textColor }}></p>
                ...
                <p className="detail-sub-content">
                  {this.props.currentBook.size
                    ? this.props.currentBook.size / 1024 / 1024 > 1
                      ? parseFloat(this.props.currentBook.size / 1024 / 1024 + "").toFixed(2) + "Mb"
            ...
            <p className="detail-dialog-book-added">
              ...
              <p className="detail-sub-content-container">
                <p className="detail-sub-content">
                  {new Date(parseInt(this.props.currentBook.key)).toLocaleString().replace(/:\d{1,2}$/, " ")}
                </p>
              </p>
            </p>
            <p className="detail-dialog-book-divider" style={{ backgroundColor: this.state.textColor }}></p>
            <p className="detail-dialog-book-added">
              ...
              <p className="detail-sub-content-container">
                <p className="detail-sub-content">{this.props.currentBook.format}</p>
              </p>
            </p>
          </div>
          <div>
